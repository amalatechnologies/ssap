<template>
  <v-container class="ma-0 pa-0" fluid>
    <v-dialog v-model="dialog" width="500">
      ...
      <v-card>
        <v-card-title class="text-h5 grey primary"> Updates </v-card-title>

        <v-card-text>
          For Android users you can no download new version of Amala Yangu
          directly from Play Store and enjoy improved look and feel. For iOS
          users we will update you soon. Click Download or Cancel otherwise
        </v-card-text>
        ...
        <v-card-actions>
          ...
          <v-btn color="green" @click="dialog = false" small>
            <a
              class="white--text"
              href="https://play.google.com/store/apps/details?id=org.mifos.amalayangu"
              target="_blank"
            >
